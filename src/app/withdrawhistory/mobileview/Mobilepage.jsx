...
const Mobilepage = () => {
    ...
    return (
        <div>
            <div className="pagecontent gridpagecontent mobilebg innerpagegrid mx-3 mt-6">
                <article className="">
                    <Container className="container sitecontainer historypage">

                        <MobileHeader title="Withdraw History" />
                                ...
                                <Table className="depo-hist-table sitetable table-responsive-stack" id="table1">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className="text-start">
                                                <div className="d-flex justify-content-between align-items-center">
                                                    <span className="t-gray">Address</span>
                                                    <span className="table-white-tt break-address">0x7A8156593Ccf2535d884Fd1E8179CB8670eF158c</span>
                                                </div>
