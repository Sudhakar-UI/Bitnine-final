        ...
        <div className="pagecontent gridpagecontent mobilebg innerpagegrid mx-3">
                ...
                <Container className="sitecontainer">
                    <div className="mbheadingbox">
                        ...
                        <div className="flex-one-cls flex-grow-1 text-center w-100">
                            <h2 className="heading-title text-center mb-0 flex-1">Security</h2>
                        </div>
                    ...
                    <div className='innerpagetab boxtabb'>
                        <Alert className="d-flex gap-2 mobile-alert-sec-red" variant="warning ">
                            <Image src="assets/images/security-level.svg" className="securityiconbox mb-0" />
                            <div>
                                <b>You Security Level : Low</b> <br /> Protect your funds by improving account security</div>
                        </Alert>
                        <Alert className="mobile-alert-sec" variant="warning">
                            <b>Note :</b> <br />For your security, withdrawals will be temporarily unavaliable for 24 hours after changing security settings
                        </Alert>
                        <div className="securitypage">
                            <div>
                                <h2 className="subhead pb-2 mb-2 text-start">Two-Factor Authentication (2FA)</h2>
                                {/* <p className="mb-0">Add an extra layer of security to your account. Use two verification steps each time you log in.</p> */}
                            </div>
                            <div className="security-com-boxs profiletablebox contentbox d-flex align-items-center gap-1">
                                <div className="d-flex align-items-center gap-3">
                                    <div>
                                        <Image src="assets/images/auth.svg" className="securityiconbox mb-0" />
                                    </div>
                                    <div>
                                        <h4 className="text-start">Google Authenticator</h4>
                                        <h5 className="t-gray text-start">Used to verify account logins, withdrawals etc.
                                        </h5>
                                    </div>
                                </div>
                                <Button id="googleauth" className="security-btn btn-sm" onClick={handleShow1}>Manage</Button>
                            </div>

                            <div className="security-com-boxs profiletablebox contentbox d-flex align-items-center gap-1 my-3">
                                <div className="d-flex align-items-start gap-3">
                                    <div>
                                        <Image src="assets/images/email.svg" className="securityiconbox mb-0" />
                                    </div>
                                    <div>
                                        <h4 className="text-start">Email Verification</h4>
                                        <h5 className="t-gray text-start">Used this email for login, recovery, and confirmation
                                        </h5>
                                    </div>
                                </div>
                                <Button id="googleauth" className="security-red-btn btn-sm" onClick={handleShow3}>Enable</Button>
                            </div>

                            <h2 className="subhead pb-2 mb-2 text-start">Identity Verification</h2>

                            <div className="security-com-boxs profiletablebox contentbox d-flex align-items-center gap-1 mb-3">
                                <div className="d-flex align-items-start gap-3">
                                    <div>
                                        <Image src="assets/images/kycicon.svg" className="securityiconbox mb-0" />
                                    </div>
                                    <div>
                                        <h4 className="text-start">KYC Verification</h4>
                                        <h5 className="t-gray text-start">Please Submit your KYC for better use and usability
                                        </h5>
                                    </div>
                                </div>
                                <Link id="kycauth" href="/kyc" className="security-btn btn-sm">Continue</Link>
                            </div>

                            <h2 className="subhead pb-2 mb-2 text-start">Advanced Settings</h2>

                            <div className="d-flex flex-column row-gap-3">
                                <div className="security-com-boxs profiletablebox contentbox d-flex align-items-center gap-1">
                                    <div className="d-flex align-items-start gap-3">
                                        <div>
                                            <Image src="assets/images/anticode.svg" className="securityiconbox mb-0" />
                                        </div>
                                        <div>
                                            <h4 className="text-start">Anti-phishing Code</h4>
                                            <h5 className="t-gray text-start">Create a unique code to confirm that emails from us are genuine and avoid phishing attempts.
                                            </h5>
                                        </div>
                                    </div>
                                    <Link id="anticodeauth" href="/anticode" className="security-btn btn-sm">Manage</Link>
                                </div>
                                <div className="security-com-boxs profiletablebox contentbox d-flex align-items-center gap-1">
                                    <div className="d-flex align-items-start gap-3">
                                        <div>
                                            <Image src="assets/images/loginpwicon.svg" className="securityiconbox mb-0" />
                                        </div>
                                        <div>
                                            <h4 className="text-start">Login Password</h4>
                                            <h5 className="t-gray text-start">Update your account password to keep your profile secure.
                                            </h5>
                                        </div>
                                    </div>
                                    <Button id="passwordauth" className="security-btn btn-sm" onClick={handleShow7}>Change</Button>
                                </div>
                                <div className="security-com-boxs profiletablebox contentbox d-flex align-items-center gap-1">
                                    <div className="d-flex align-items-start gap-3">
                                        <div>
                                            <Image src="assets/images/account-activities.svg" className="securityiconbox mb-0" />
                                        </div>
                                        <div>
                                            <h4 className="text-start">Account Activities</h4>
                                            <h5 className="t-gray text-start">Review your login and security activity.
                                            </h5>
                                        </div>
                                    </div>
                                    <Link id="activityauth" href="/accountactivity" className="security-btn btn-sm">View</Link>
                                </div>
                                <div className="security-com-boxs profiletablebox contentbox d-flex align-items-center gap-1">
                                    <div className="d-flex align-items-start gap-3">
                                        <div>
                                            <Image src="assets/images/delete.svg" className="securityiconbox mb-0" />
                                        </div>
                                        <div>
                                            <h4 className="text-start">Delete Account</h4>
                                            <h5 className="t-gray text-start">Warning: Permanently delete your account. This action cannot be undone.
                                            </h5>
                                        </div>
                                    </div>
                                    <Link id="deleteauth" href="/deleteaccount" className="security-btn btn-sm">Proceed</Link>
                                </div>
                                <div className="security-com-boxs profiletablebox contentbox d-flex align-items-center gap-1">
                                    <div className="d-flex align-items-start gap-3">
                                        <div>
                                            <Image src="assets/images/freeze-account.svg" className="securityiconbox mb-0" />
                                        </div>
                                        <div>
                                            <h4 className="text-start">Freeze Account</h4>
                                            <h5 className="t-gray text-start">Freeze your account to disable all functions immediately.
                                            </h5>
                                        </div>
                                    </div>
                                    <Link id="deleteauth" href="/freezeaccount" className="security-btn btn-sm">Proceed</Link>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <Modal.Body>
                    <Form className='siteformbg'>
                        ...
                        <div className="d-flex gap-2 mt-3">
                            <Button type="button" className="security-canel-btn" id="cancel">Cancel</Button>
            ...
            <Modal show={showModal2} onHide={handleClose2} className='modalbgt authmodal' aria-labelledby="contained-modal-title-vcenter"
                ...
                <Modal.Body>
                    ...
                    <div className="d-flex gap-2 mt-3">
                        <Button type="button" className="security-canel-btn" data-bs-dismiss="modal">Cancel</Button>
            ...
            <Modal show={showModal6} onHide={handleClose6} className='modalbgt authmodal' aria-labelledby="contained-modal-title-vcenter" centered>
                ...
                <Modal.Body>
                    ...
                    <div className="d-flex gap-2 mt-3">
                        <Button type="button" className="security-canel-btn">Cancel</Button>
            ...
            <Modal show={showModal10} onHide={handleClose10} className='modalbgt authmodal' aria-labelledby="contained-modal-title-vcenter"
                ...
                <Modal.Body>
                    <p className="content">Your account security level is low, please enable at least one more verification method.</p>
                    <div className="fundboxb">
                        <a href="#" onClick={() => { handleClose10(); handleShow1(); }} className="table-content lightgraybg">
                            ...
                            <div className="">
                                <h5 className="">Authenticator App <span className="text-black fw-normal">(Recommended)</span></h5>
                            </div>
                            <div className="text-end">
                                <div className="g-auth-arrow">
