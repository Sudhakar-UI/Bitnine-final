...
import { Modal, Image, Table, Tab, Nav, Form, Container, Row, Col, Button, InputGroup, Dropdown, OverlayTrigger, Tooltip, NavDropdown } from 'react-bootstrap';
import SimpleBar from 'simplebar-react';
import 'simplebar-react/dist/simplebar.min.css';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faEye, faCircleInfo, faSearch, faArrowLeft } from '@fortawesome/free-solid-svg-icons';
...
const Mobilepage = () => {
    ...
    return (
        <div className="wallet-mobile mobilebg wallet-spot">
            <div className="pagecontent gridpagecontent innerpagegrid">

                <article className="mx-2 gridtabtopbox">
                    <Container className="sitecontainer walletoverviewbg">
                        <div className="mbheadingbox">
                            ...
                            <div className="flex-one-cls flex-grow-1 text-center w-100">
                                <h2 className="heading-title text-center mb-0 flex-1">Spot Wallet</h2>
                            </div>
                        ...
                        <div className="wallet-ph mt-3">
                            <div className="innerpagecontent">
                                    ...
                                    <div className="wallet-nav-btn justify-content-between w-100">
                                        <div className="d-flex align-items-center gap-2">
                                            <div className="wallet-nav-img">
                                                <Image src="assets/images/wallet-frame-two.svg" alt="icon" width={100} height={100} />
                                            </div>
                                ...
                                <div className="d-flex  gap-3 justify-content-between wallet-ph-div">
                                    <div className="wallet-nav-btn justify-content-between wallet-over-main w-100">
                                        <div className="d-flex align-items-center gap-2">
                                            <div className="wallet-nav-img">
                                                <Image src="assets/images/wallet-frame-three.svg" style={{ filter: 'brightness(0) invert(1)' }} alt="icon" width={100} height={100} />
                                            </div>
                            ...
                            <div className="d-flex justify-content-between align-items-start mb-3 border-line">
                                <div>
                                    <p className="mb-1">Estimated Balance</p>
                            ...
                            <div className="flexbox mt-3 wallet-search-move">
                                <div className="panelcontentbox wllettable pt-2 p-0">
                                            ...
                                            <div className="wallet-tbl">
                                                <Form.Group className="form-group mo-view wallet-search-main">
                                                    <InputGroup className="supportsearch">
                                                        ...
                                                        <div className="expand-input spot-wall-expand-input">
                                    ...
                                    <div className="px-2">
                                        <Form.Check type="checkbox" id="spotcheck" label="Hide Zero Amount" />
                                    </div>
                                    <div className="market-box mobile-table mt-1">
                                        <div className="flex-market market-head-dash">
                                            ...
                                            <div className="d-flex">
                                                <Link
                                                    ...
                                                    href="#0"
                                                    id="register"
                                                    className="nav-link btn alink me-1 ms-2"
                                                >
                                                    Transfer
                                                </Link>
                                            </div>
                                        ...
                                        <div className="flex-market mt-2">
                                            <p className="tt-sub-text mb-1">Amout</p>
                                            <p className="tt-main-text mb-1">2562.365289</p>
                                        </div>
                                        <div className="flex-market">
                                            <p className="tt-sub-text mb-1">Coin Price</p>
                                            <p className="tt-main-text mb-1">2562.365289</p>
                            ...
                            <Modal show={showModal1} onHide={handleClose1} className='modalbgt' aria-labelledby="contained-modal-title-vcenter" centered>
                                ...
                                <Modal.Body className="px-1">
                                    <div className="siteformbg d-flex flex-column gap-2">
                                        <Form.Group>
