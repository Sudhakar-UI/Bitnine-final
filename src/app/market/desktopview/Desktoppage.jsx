...
const Desktoppage = () => {
    ...
    return (
        <>
            <article className="innerpage marketsdk-page">
                <Homeheader />
                <div className="innerpages">
                    <Container className="markets-page-bg">
                        <h2 className="heading-title pb-3 text-center">Markets</h2>
                        <div className="market-panel panelcontentbox">
